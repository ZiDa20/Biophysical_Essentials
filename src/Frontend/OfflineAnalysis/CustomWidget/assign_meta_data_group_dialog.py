...
class Ui_assign_meta_data_group(object):
    def setupUi(self, assign_meta_data_group):
        ...
        sizePolicy.setHeightForWidth(assign_meta_data_group.sizePolicy().hasHeightForWidth())
        assign_meta_data_group.setSizePolicy(sizePolicy)
        ...
        self.comboBox.setMinimumSize(QSize(175, 0))
        ...
        self.gridLayout.addLayout(self.meta_data_template_layout, 2, 0, 1, 5)
