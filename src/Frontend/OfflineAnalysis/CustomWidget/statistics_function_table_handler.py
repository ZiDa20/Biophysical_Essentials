...
from Frontend.OfflineAnalysis.CustomWidget.statistics_function_table import Ui_StatisticsTable
from Frontend.OfflineAnalysis.CustomWidget.statistics_result_template_handler import StatisticsResultTemplate
