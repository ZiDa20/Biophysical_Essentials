...
################################################################################
## Form generated from reading UI file 'specific_analysis_tab_30062022.ui'
##
...
class Ui_SpecificAnalysisTab(object):
    def setupUi(self, SpecificAnalysisTab):
        ...
        SpecificAnalysisTab.setEnabled(True)
        ...
        sizePolicy2.setHeightForWidth(self.select_series_analysis_functions.sizePolicy().hasHeightForWidth())
        self.select_series_analysis_functions.setSizePolicy(sizePolicy2)
        ...
        sizePolicy.setHeightForWidth(self.analysis_table_widget.sizePolicy().hasHeightForWidth())
        self.analysis_table_widget.setSizePolicy(sizePolicy)
        ...
        self.turn_on_peak_detection = QRadioButton(SpecificAnalysisTab)
        self.turn_on_peak_detection.setObjectName(u"turn_on_peak_detection")
        self.turn_on_peak_detection.setEnabled(True)

        self.gridLayout.addWidget(self.turn_on_peak_detection, 7, 13, 1, 1)
