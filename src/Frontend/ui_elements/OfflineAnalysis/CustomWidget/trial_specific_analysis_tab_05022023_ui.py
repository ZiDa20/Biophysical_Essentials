...
from Frontend.OfflineAnalysis.CustomWidget.analysis_functions import Analysis_Functions
...
class Ui_SpecificAnalysisTab(object):
    def setupUi(self, SpecificAnalysisTab):
        ...
        self.analysis_functions = Analysis_Functions(SpecificAnalysisTab)
        self.analysis_functions.setObjectName(u"analysis_functions")

        self.gridLayout_5.addWidget(self.analysis_functions, 0, 7, 1, 1)
