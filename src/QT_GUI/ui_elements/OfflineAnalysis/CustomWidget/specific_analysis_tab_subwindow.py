...
class Ui_SpecificAnalysisTab(object):
    def setupUi(self, SpecificAnalysisTab):
        ...
        self.CameraWindow.setMinimumSize(QSize(300, 400))
        ...
        self.DataWindow = QWidget()
        self.DataWindow.setObjectName(u"DataWindow")
        self.gridLayout_4 = QGridLayout(self.DataWindow)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.stackedWidget = QStackedWidget(self.DataWindow)
        ...
        self.CameraMDI.addSubWindow(self.DataWindow)
    ...
    def retranslateUi(self, SpecificAnalysisTab):
        ...
        self.DataWindow.setWindowTitle(QCoreApplication.translate("SpecificAnalysisTab", u"Subwindow", None))
