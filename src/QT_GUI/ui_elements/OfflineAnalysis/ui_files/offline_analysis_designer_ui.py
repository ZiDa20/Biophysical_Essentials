...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.StartAnalysis.sizePolicy().hasHeightForWidth())
        self.StartAnalysis.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_16.setContentsMargins(1, 3, 1, 15)
        ...
        sizePolicy2.setHeightForWidth(self.treebuild.sizePolicy().hasHeightForWidth())
        self.treebuild.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.plot_page.sizePolicy().hasHeightForWidth())
        self.plot_page.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.animation_page.sizePolicy().hasHeightForWidth())
        self.animation_page.setSizePolicy(sizePolicy2)
