...
class Ui_Offline_Analysis(object):
        def setupUi(self, Offline_Analysis):
                ...
                self.fo_forward_button.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/forward.png);")
                ...
                self.load_from_database.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/load_database.png);")
                ...
                self.load_meta_data.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/add_meta.png);")
                ...
                self.select_directory_button.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/open.png);")
                ...
                self.edit_meta.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/edit_metadata.png);")
                ...
                self.save_plot_online.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/save_img.png);")
                ...
                self.add_filter_button.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/filter_db.png);")
                ...
                self.delete_selected.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/delete.png);")
                ...
                self.compare_series.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/select_big.png);")
                ...
                self.start_analysis.setStyleSheet(
                        u"background-image: url(../QT_GUI/Button/OnlineAnalysis/start_analysis.png);")
        ...
        def retranslateUi(self, Offline_Analysis):
                ...
                self.add_filter_button.setToolTip(QCoreApplication.translate("Offline_Analysis",
                                                                             u"<html><head/><body><p>Add Filters </p></body></html>",
                                                                             None))
                # endif // QT_CONFIG(tooltip)
                self.add_filter_button.setText("")
                # if QT_CONFIG(tooltip)
                self.sort_by.setToolTip(QCoreApplication.translate("Offline_Analysis",
                                                                   u"<html><head/><body><p>Sort by Metadata Categories</p></body></html>",
                                                                   None))
                # endif // QT_CONFIG(tooltip)
                self.sort_by.setText("")
                # if QT_CONFIG(tooltip)
                self.delete_selected.setToolTip(QCoreApplication.translate("Offline_Analysis",
                                                                           u"<html><head/><body><p>Delete the selected experiments</p></body></html>",
                                                                           None))
                # endif // QT_CONFIG(tooltip)
                self.delete_selected.setText("")
                # if QT_CONFIG(tooltip)
                self.select.setToolTip(QCoreApplication.translate("Offline_Analysis",
                                                                  u"<html><head/><body><p>Multi-select several experiments in the tree</p></body></html>",
                                                                  None))
                # endif // QT_CONFIG(tooltip)
                self.select.setText("")
                self.SeriesSelection.setTitle(QCoreApplication.translate("Offline_Analysis", u"Select Series", None))
                # if QT_CONFIG(tooltip)
                self.compare_series.setToolTip(QCoreApplication.translate("Offline_Analysis",
                                                                          u"<html><head/><body><p>Specifiy which Series should be analyzed</p></body></html>",
                                                                          None))
                # endif // QT_CONFIG(tooltip)
