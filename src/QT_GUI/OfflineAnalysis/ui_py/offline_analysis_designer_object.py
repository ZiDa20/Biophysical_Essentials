...
class Ui_Offline_Analysis(object):
    def setupUi(self, Offline_Analysis):
        ...
        Offline_Analysis.resize(1253, 704)
...
"}")
        ...
        self.gridLayout_35.setContentsMargins(0, -1, 3, -1)
        ...
        sizePolicy.setHeightForWidth(self.ribbon_series_normalization.sizePolicy().hasHeightForWidth())
        self.ribbon_series_normalization.setSizePolicy(sizePolicy)
        self.ribbon_series_normalization.setLineWidth(0)
        self.page = QWidget()
        ...
        self.SeriesSelection.setMaximumSize(QSize(16777215, 16777215))
        self.gridLayout_18 = QGridLayout(self.SeriesSelection)
        self.gridLayout_18.setObjectName(u"gridLayout_18")
        self.gridLayout_18.setSizeConstraint(QLayout.SetNoConstraint)
        ...
        self.gridLayout_35.addWidget(self.ribbon_series_normalization, 0, 0, 1, 1)

        self.ribbon_analysis = QStackedWidget(self.frame)
        self.ribbon_analysis.setObjectName(u"ribbon_analysis")
        sizePolicy.setHeightForWidth(self.ribbon_analysis.sizePolicy().hasHeightForWidth())
        self.ribbon_analysis.setSizePolicy(sizePolicy)
        self.page_4 = QWidget()
        ...
        self.gridLayout_20.setSizeConstraint(QLayout.SetNoConstraint)
        ...
        self.gridLayout_35.addWidget(self.ribbon_analysis, 0, 1, 1, 1)


        self.gridLayout_13.addLayout(self.gridLayout_35, 0, 8, 1, 1)

        self.gridLayout_32 = QGridLayout()
        self.gridLayout_32.setObjectName(u"gridLayout_32")
        self.gridLayout_32.setHorizontalSpacing(10)
        self.gridLayout_32.setContentsMargins(3, -1, 10, 1)
        self.DataGroup = QGroupBox(self.frame)
        self.DataGroup.setObjectName(u"DataGroup")
        sizePolicy2 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.DataGroup.sizePolicy().hasHeightForWidth())
        self.DataGroup.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_32.addWidget(self.DataGroup, 0, 1, 1, 1)

        self.FilterOptions = QGroupBox(self.frame)
        self.FilterOptions.setObjectName(u"FilterOptions")
        sizePolicy2.setHeightForWidth(self.FilterOptions.sizePolicy().hasHeightForWidth())
        self.FilterOptions.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_32.addWidget(self.FilterOptions, 0, 3, 1, 1)

        self.PlotGroup = QGroupBox(self.frame)
        self.PlotGroup.setObjectName(u"PlotGroup")
        sizePolicy2.setHeightForWidth(self.PlotGroup.sizePolicy().hasHeightForWidth())
        self.PlotGroup.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_32.addWidget(self.PlotGroup, 0, 5, 1, 1)
        ...
        self.gridLayout_32.addWidget(self.groupBox_8, 0, 4, 1, 1)
        ...
        self.gridLayout_32.addWidget(self.groupBox_6, 0, 2, 1, 1)
        ...
        self.gridLayout_13.addLayout(self.gridLayout_32, 0, 7, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.plot_page.sizePolicy().hasHeightForWidth())
        self.plot_page.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.animation_page.sizePolicy().hasHeightForWidth())
        self.animation_page.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.SeriesItems_2.sizePolicy().hasHeightForWidth())
        self.SeriesItems_2.setSizePolicy(sizePolicy1)
