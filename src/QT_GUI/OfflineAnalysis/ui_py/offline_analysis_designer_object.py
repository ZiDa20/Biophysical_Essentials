...
class Ui_Offline_Analysis(object):
    def setupUi(self, Offline_Analysis):
        ...
        Offline_Analysis.resize(1428, 704)
...
"}")
        ...
        self.gridLayout_13.addWidget(self.ribbon_analysis, 0, 13, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.ribbon_series_normalization, 0, 12, 1, 1)
        ...
        self.gridLayout_13.addWidget(self.line, 0, 10, 2, 1)

        self.gridLayout_32 = QGridLayout()
        self.gridLayout_32.setObjectName(u"gridLayout_32")
        self.gridLayout_32.setHorizontalSpacing(10)
        self.gridLayout_32.setContentsMargins(3, -1, 3, 1)
        ...
        self.gridLayout_13.addLayout(self.gridLayout_32, 0, 9, 1, 1)
