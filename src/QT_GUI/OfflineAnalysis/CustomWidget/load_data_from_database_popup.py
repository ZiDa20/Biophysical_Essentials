...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy1.setHeightForWidth(self.available_labels.sizePolicy().hasHeightForWidth())
        self.available_labels.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_2.addLayout(self.label_grid, 3, 0, 1, 1)
        ...
        self.label_2 = QLabel(self.available_labels)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setMaximumSize(QSize(16777215, 50))

        self.gridLayout_2.addWidget(self.label_2, 0, 0, 1, 1)

        self.label_3 = QLabel(self.available_labels)
        ...
        self.gridLayout_2.addWidget(self.switch_to_manual, 5, 0, 1, 1)

        self.load_data = QPushButton(self.available_labels)
        ...
        self.gridLayout_2.addWidget(self.load_data, 4, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.execute_query, 3, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.query_input, 2, 0, 1, 1)

        self.switch_to_auto = QPushButton(self.groupBox)
        self.switch_to_auto.setObjectName(u"switch_to_auto")

        self.gridLayout_8.addWidget(self.switch_to_auto, 6, 0, 1, 1)

        self.query_output = QLineEdit(self.groupBox)
        self.query_output.setObjectName(u"query_output")

        self.gridLayout_8.addWidget(self.query_output, 4, 0, 1, 1)

        self.show_er_diagram = QPushButton(self.groupBox)
        self.show_er_diagram.setObjectName(u"show_er_diagram")

        self.gridLayout_8.addWidget(self.show_er_diagram, 1, 0, 1, 1)
        ...
        self.load_data_2 = QPushButton(self.groupBox)
        self.load_data_2.setObjectName(u"load_data_2")
        self.load_data_2.setMaximumSize(QSize(16777215, 40))

        self.gridLayout_8.addWidget(self.load_data_2, 5, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Search Experiments by:", None))
        self.label_3.setText(QCoreApplication.translate("Dialog", u"Select a meta data group to start an offline analysis.", None))
        self.switch_to_manual.setText(QCoreApplication.translate("Dialog", u"Switch To Manual Selection", None))
        self.load_data.setText(QCoreApplication.translate("Dialog", u"Load Selected Data", None))
        ...
        self.show_er_diagram.setText(QCoreApplication.translate("Dialog", u"Show ER Diagram", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"You can query experiment data by entering a SQL query below. The result will be printed on the right.  ", None))
        self.load_data_2.setText(QCoreApplication.translate("Dialog", u"Load Selected Data", None))
    # retranslateUi
