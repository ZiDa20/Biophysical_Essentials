...
class Ui_MetadataPopup(object):
    def setupUi(self, MetadataPopup):
        ...
        self.stackedWidget = QStackedWidget(MetadataPopup)
        ...
        self.metadata_all.addLayout(self.button_layout, 1, 1, 1, 1)
        ...
        self.table_widget = QWidget(self.groupBox)
        ...
        self.final_table_layout.addWidget(self.tableView, 0, 0, 1, 1, Qt.AlignTop)


        self.gridLayout_8.addLayout(self.final_table_layout, 1, 0, 1, 1)


        self.gridLayout_7.addWidget(self.table_widget, 0, 0, 1, 1)


        self.table_layout.addWidget(self.groupBox, 0, 0, 1, 1)


        self.metadata_all.addLayout(self.table_layout, 1, 0, 1, 1)

        self.gridLayout_4 = QGridLayout()
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.label_2 = QLabel(self.LoadAnalysis)
        self.label_2.setObjectName(u"label_2")

        self.gridLayout_4.addWidget(self.label_2, 0, 0, 1, 1)

        self.line = QFrame(self.LoadAnalysis)
        ...
        self.OfflineAnalysisID = QComboBox(self.LoadAnalysis)
        self.OfflineAnalysisID.setObjectName(u"OfflineAnalysisID")

        self.gridLayout_4.addWidget(self.OfflineAnalysisID, 0, 3, 1, 1)

        self.submit = QPushButton(self.LoadAnalysis)
        ...
        self.gridLayout_4.addWidget(self.submit, 0, 4, 1, 1)

        self.horizontalSpacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_4.addItem(self.horizontalSpacer, 0, 5, 1, 1)

        self.SelectDB = QPushButton(self.LoadAnalysis)
        self.SelectDB.setObjectName(u"SelectDB")

        self.gridLayout_4.addWidget(self.SelectDB, 0, 1, 1, 1)


        self.metadata_all.addLayout(self.gridLayout_4, 0, 0, 1, 1)


        self.gridLayout.addLayout(self.metadata_all, 0, 0, 1, 1)

        self.stackedWidget.addWidget(self.LoadAnalysis)
        ...
        self.button_layout_2 = QGridLayout()
        self.button_layout_2.setObjectName(u"button_layout_2")

        self.metadata_all_2.addLayout(self.button_layout_2, 1, 1, 1, 1)

        self.table_layout_2 = QGridLayout()
        self.table_layout_2.setObjectName(u"table_layout_2")
        self.table_widget_2 = QWidget(self.ExportAnalysis)
        ...
        self.table_widget_2.setMinimumSize(QSize(500, 500))
        self.gridLayout_9 = QGridLayout(self.table_widget_2)
        self.gridLayout_9.setSpacing(0)
        self.gridLayout_9.setObjectName(u"gridLayout_9")
        self.gridLayout_9.setContentsMargins(0, 0, 0, 0)
        self.groupBox_2 = QGroupBox(self.table_widget_2)
        ...
        sizePolicy2.setHeightForWidth(self.tableView_2.sizePolicy().hasHeightForWidth())
        self.tableView_2.setSizePolicy(sizePolicy2)
        ...
        self.final_table_layout_2 = QGridLayout()
        self.final_table_layout_2.setObjectName(u"final_table_layout_2")

        self.gridLayout_9.addLayout(self.final_table_layout_2, 1, 0, 1, 3)


        self.table_layout_2.addWidget(self.table_widget_2, 0, 0, 1, 1)
        ...
        self.stackedWidget.addWidget(self.ExportAnalysis)
