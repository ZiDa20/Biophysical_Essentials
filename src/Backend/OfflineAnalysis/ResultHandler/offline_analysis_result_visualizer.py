...
from Backend.OfflineAnalysis.Plotting.ResultPlotVisualizer import ResultPlotVisualizer
...
from Frontend.OfflineAnalysis.CustomWidget.tab_offline_result import OfflineResultTab
