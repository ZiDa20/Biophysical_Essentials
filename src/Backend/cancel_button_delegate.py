        ...
        if index.column() == self.col_count:  # assuming the pixmap will be in the last column
            if self.delete == True:
                if self.frontend_style == 1:
                    pixmap = QPixmap(r":Frontend/Button/light_mode/offline_analysis/treeview_delete.png")
                else:
                    pixmap = QPixmap(r":Frontend/Button/dark_mode/offline_analysis/treeview_delete.png")
            else:
                if self.frontend_style ==1:
                    pixmap = QPixmap(r":Frontend/Button/light_mode/offline_analysis/treeview_reinsert.png")
                else:
                    pixmap = QPixmap(r":Frontend/Button/dark_mode/offline_analysis/treeview_reinsert.png")
