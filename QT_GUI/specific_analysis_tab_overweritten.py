...
class Ui_SpecificAnalysisTab(object):
    def setupUi(self, SpecificAnalysisTab):
        ...
        SpecificAnalysisTab.resize(1339, 857)
        self.verticalLayoutWidget_2 = QWidget(SpecificAnalysisTab)
        self.verticalLayoutWidget_2.setObjectName(u"verticalLayoutWidget_2")
        self.verticalLayoutWidget_2.setGeometry(QRect(510, 130, 781, 221))
        ...
        self.gridLayoutWidget = QWidget(SpecificAnalysisTab)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(360, 410, 931, 381))
        ...
        self.pushButton = QPushButton(SpecificAnalysisTab)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(350, 210, 71, 51))
        self.pushButton_2 = QPushButton(SpecificAnalysisTab)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(350, 290, 71, 51))
        self.pushButton_3 = QPushButton(SpecificAnalysisTab)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(350, 130, 71, 51))
        self.gridLayoutWidget_2 = QWidget(SpecificAnalysisTab)
        self.gridLayoutWidget_2.setObjectName(u"gridLayoutWidget_2")
        self.gridLayoutWidget_2.setGeometry(QRect(20, 30, 1271, 51))
        ...
        self.gridLayoutWidget_3.setGeometry(QRect(460, 810, 239, 41))
    ...
    def retranslateUi(self, SpecificAnalysisTab):
        ...
        self.select_series_analysis_functions.setText(QCoreApplication.translate("SpecificAnalysisTab", u"PushButton", None))
        ...
        self.pushButton_4.setText(QCoreApplication.translate("SpecificAnalysisTab", u"Add New Filter", None))
        self.label_3.setText(QCoreApplication.translate("SpecificAnalysisTab", u"No filter selected", None))
        self.pushButton_5.setText(QCoreApplication.translate("SpecificAnalysisTab", u"PushButton", None))
        self.pushButton_6.setText(QCoreApplication.translate("SpecificAnalysisTab", u"PushButton", None))
        self.pushButton_7.setText(QCoreApplication.translate("SpecificAnalysisTab", u"PushButton", None))
    # retranslateUi
