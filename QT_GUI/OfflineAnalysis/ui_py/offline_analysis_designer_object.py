...
class Ui_Offline_Analysis(object):
    def setupUi(self, Offline_Analysis):
        ...
        self.select_directory_button.setGeometry(QRect(260, 20, 100, 41))
        ...
        self.selected_directory.setGeometry(QRect(370, 20, 111, 42))
        self.load_from_database = QPushButton(self.groupBox_2)
        self.load_from_database.setObjectName(u"load_from_database")
        self.load_from_database.setGeometry(QRect(10, 20, 100, 41))
        ...
        self.load_meta_data.setGeometry(QRect(130, 20, 91, 41))
