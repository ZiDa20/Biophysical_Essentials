...
################################################################################
## Form generated from reading UI file 'online_analysis_notebook_2.ui'
##
...
class Ui_Online_Analysis(object):
    def setupUi(self, Online_Analysis):
        ...
        Online_Analysis.resize(954, 888)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Online_Analysis.sizePolicy().hasHeightForWidth())
        Online_Analysis.setSizePolicy(sizePolicy)
        ...
        self.groupBox_5.setMaximumSize(QSize(500, 16777215))
