...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Logo_home_2.sizePolicy().hasHeightForWidth())
        self.Logo_home_2.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.database_viewer_home_2.sizePolicy().hasHeightForWidth())
        self.database_viewer_home_2.setSizePolicy(sizePolicy2)
...
"}")
        ...
        self.maximize_button.setFont(font2)
        ...
        self.minimize_button.setFont(font2)
