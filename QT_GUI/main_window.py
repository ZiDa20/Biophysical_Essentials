...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.side_left_menu.setMaximumSize(QSize(8777215, 50000))
        ...
        self.verticalLayout.addWidget(self.hamburger_button)
        ...
        self.verticalLayout.addWidget(self.konsole_button)
