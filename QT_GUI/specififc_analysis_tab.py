...
class Ui_SpecificAnalysisTab(object):
    def setupUi(self, SpecificAnalysisTab):
        ...
        self.label_7.setGeometry(QRect(10, 100, 261, 42))
        ...
        self.gridLayout.addWidget(self.start_analysis_button, 8, 12, 1, 5)
        ...
        self.gridLayout.addWidget(self.groupBox, 1, 3, 7, 14)
        ...
        self.gridLayout.addWidget(self.select_series_analysis_functions, 8, 3, 1, 4)
        ...
        self.gridLayout.addWidget(self.groupBox_5, 9, 3, 10, 14)
        ...
        self.gridLayout.addWidget(self.groupBox_4, 6, 1, 10, 1)
