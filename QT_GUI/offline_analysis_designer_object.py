...
class Ui_Offline_Analysis(object):
    def setupUi(self, Offline_Analysis):
        ...
        Offline_Analysis.resize(1663, 962)
        ...
        sizePolicy.setHeightForWidth(self.new_analysis_with_template.sizePolicy().hasHeightForWidth())
        self.new_analysis_with_template.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.view_analysis_from_db.sizePolicy().hasHeightForWidth())
        self.view_analysis_from_db.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_4.addWidget(self.start_label, 0, 1, 1, 1)

        self.user_feedback_label = QLabel(self.start_page)
        self.user_feedback_label.setObjectName(u"user_feedback_label")
        sizePolicy.setHeightForWidth(self.user_feedback_label.sizePolicy().hasHeightForWidth())
        self.user_feedback_label.setSizePolicy(sizePolicy)

        self.gridLayout_4.addWidget(self.user_feedback_label, 1, 2, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.blank_analysis_button.sizePolicy().hasHeightForWidth())
        self.blank_analysis_button.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_4.addItem(self.horizontalSpacer_6, 3, 3, 1, 1)

        self.horizontalSpacer_7 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_4.addItem(self.horizontalSpacer_7, 4, 3, 1, 1)
    ...
    def retranslateUi(self, Offline_Analysis):
        ...
        self.new_analysis_with_template.setText(
            QCoreApplication.translate("Offline_Analysis", u"New Analysis using previous analysis as template", None))
        self.view_analysis_from_db.setText(
            QCoreApplication.translate("Offline_Analysis", u"View Analysis From Database", None))
        self.start_label.setText(
            QCoreApplication.translate("Offline_Analysis", u"SELECT THE ANALYSIS YOU WANT TO PERFORM", None))
        self.user_feedback_label.setText(
            QCoreApplication.translate("Offline_Analysis", u" Configure a new analysis from the scratch. \n"
                                                           " Define filter settings to discard in an automated manner, \n"
                                                           " select and discard experiments manually, \n"
                                                           " set up analysis function and specify regions of interest. ",
                                       None))
        self.blank_analysis_button.setText(QCoreApplication.translate("Offline_Analysis", u"New Blank Analysis", None))
        self.label_2.setText(QCoreApplication.translate("Offline_Analysis",
                                                        u" Simply apply previous analysis settings to new experiment files.\n"
                                                        " Additional changes are possible too", None))
        self.label_3.setText(
            QCoreApplication.translate("Offline_Analysis", u" View Visualizations of preovious analysis. \n"
                                                           " It's a read only mode - You can not modify the analysis",
                                       None))
        ...
        self.widget_sepcific_label.setText(
            QCoreApplication.translate("Offline_Analysis", u"CONFIGURE YOUR OFFLINE ANALYSIS", None))
