...
class Ui_Offline_Analysis(object):
    def setupUi(self, Offline_Analysis):
        ...
        self.gridLayout_4.addWidget(self.blank_analysis_button, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.user_feedback_label, 2, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.new_analysis_with_template, 3, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.view_analysis_from_db, 4, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.widget_sepcific_label, 0, 3, 1, 1)
        ...
        self.gridLayout_9 = QGridLayout(self.filter_box)
        ...
        self.gridLayout_5.addWidget(self.directory_tree_widget, 3, 0, 3, 2)
        ...
        self.gridLayout_3.addWidget(self.offline_analysis_widgets, 0, 0, 1, 1)
